...
class Predictor(nn.Module):
    ...
    def __init__(self, model, class_names, mean, std):
        ...
        self.transformsX = nn.Sequential(
            torchvision.transforms.Resize([256, ], antialias=True),  # We use single int value inside a list due to torchscript type restrictions
